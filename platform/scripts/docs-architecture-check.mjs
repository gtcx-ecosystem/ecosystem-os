...
function main() {
  ...
  gates.push(
    gate('spec:local-present', !!resolution.localPath || existsSync(join(REPO, '../../gtcx.infrastructure/canon-os/pm/spec', PACK)), resolution.localPath ?? 'missing machine/spec/docs-architecture-pack.json'),
  );
  gates.push(
    gate(
      'spec:not-stub',
