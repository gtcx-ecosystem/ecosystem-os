...
This folder stores selected Ecosystem OS image assets generated for product, documentation, presentation, campaign, and institutional storytelling use. ChatGPT image generation is the default generator unless a manifest entry states otherwise.
...
Every selected asset should be listed in `machine/media/library.manifest.json`. Do not store experimental rejects in this folder.
