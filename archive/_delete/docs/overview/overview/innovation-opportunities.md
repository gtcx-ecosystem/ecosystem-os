...
- **Current implementation status or codebase reality**: See `01-docs/strategy/implementation-truth.md` for an honest assessment of what is built vs. what is designed
- **Technical architecture, protocol specs, or engineering standards**: See `01-docs/specs/`, `01-docs/architecture/`, and `01-docs/engineering/` for technical documentation
- **Operational procedures, runbooks, or compliance frameworks**: See `01-docs/04-ops/` and `01-docs/10-compliance/` for operational and compliance guidance
