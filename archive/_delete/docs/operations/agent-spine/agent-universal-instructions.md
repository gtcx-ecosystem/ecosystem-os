...
**Canonical (BaselineOS — orchestrates canon-os + repo + gates + agile-os ingest):**
...
**Chain:** canon-os INST-003 → repo session (via `run-repo-session` / `bin/agent`) → repo gates → optional `--ingest` via agile-os/baseline-os work-next.
...
| 6    | [Multi-pillar audit agent index](../governance/audit/multi-pillar-agent-index.md) — Foundation (F-PiLLAR) + Transformational (T-PiLLAR); not "five pillars only"       |
...
## 5. Provider entry points (Protocol 39 — dot dirs only)

**Normative:** [Protocol 39](../governance/protocols/provider-agnostic-agent-bootstrap/protocol.md)

`AGENTS.md` at repo root is the **universal** entry (REQUIRED). Provider-specific files **MUST NOT** exist at root.

All synced from bridge-os templates via `pnpm agent:sync`:

| Provider    | Canonical path (only)                                              | FORBIDDEN at root |
| ----------- | ------------------------------------------------------------------ | ----------------- |
| Universal   | `AGENTS.md`                                                        | —                 |
| Claude      | `.claude/CLAUDE.md`                                                | `CLAUDE.md`       |
| Kimi        | `.kimi/AGENTS.md`                                                  | `KIMI.md`         |
| Gemini      | `.gemini/GEMINI.md`                                                | `GEMINI.md`       |
| Codex       | `AGENTS.md` + `.agent/`                                            | `CODEX.md`        |
| Cursor      | `.cursor/rules/main.mdc`, `protocol-26-*.mdc`, `protocol-27-*.mdc` | `CURSOR.md`       |
...
## 6. Normative hub (canon-os)

| Protocol | Path                                                                      |
| -------- | ------------------------------------------------------------------------- |
| P22      | `01-docs/governance/protocols/agent-work-selection/protocol.md`           |
| P26      | `01-docs/governance/protocols/agent-proceed-confirmation/protocol.md`     |
| P27      | `01-docs/governance/protocols/agent-execution-obligation/protocol.md`     |
| P28      | `01-docs/governance/protocols/agent-authority-classification/protocol.md` |
