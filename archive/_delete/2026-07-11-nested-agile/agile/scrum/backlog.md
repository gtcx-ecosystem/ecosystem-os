...
> **ecosystem-os aggregates** program priority and navigation. **baseline-os stores** cross-repo blockers, inbound tickets, and coordination indexes. **Each repo owns** its execution roadmap and deliverables.
...
| V1 program waves / UAT | **ecosystem-os** | [`01-01-docs/v1-shipping/ecosystem-v1-ssot.md`](../v1-shipping/ecosystem-v1-ssot.md) |
| Dependency graph metadata | **ecosystem-os** | [`03-platform/03-platform/src/ecosystem-graph.ts`](../../03-platform/03-platform/src/ecosystem-graph.ts) |
...
| `ecosystem-os` | `ecosystem-os/01-01-docs/strategy/execution-roadmap.md` | — |
