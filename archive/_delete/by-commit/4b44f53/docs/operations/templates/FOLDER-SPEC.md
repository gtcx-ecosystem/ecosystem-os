---
title: 'operations/templates/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/templates']
review_cycle: on-change
---

# `docs/operations/templates/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/templates/ narrative and specs for ecosystem-os.
