---
title: 'operations/organization/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/organization']
review_cycle: on-change
---

# `docs/operations/organization/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/organization/ narrative and specs for ecosystem-os.
