...
Fleet product domain narrative lives in **[ecosystem-os/docs/business/domain/](../../ecosystem-os/docs/business/domain/)** — ecosystem-os keeps pointers and cross-reference tables only.
