...
| [`../../../../pm/spec/kaleidoscope-ai/phase-3-resource-replay.schema.json`](../../../../pm/spec/kaleidoscope-ai/phase-3-resource-replay.schema.json) | Phase 3 resource replay witness contract for deterministic fingerprints, source witness hashes, and approval-boundary validation. |
...
| [`../../../../audit/evidence/kaleidoscope-graph-rag-mcp-strict-fleet-pin-latest.json`](../../../../audit/evidence/kaleidoscope-graph-rag-mcp-strict-fleet-pin-latest.json) | Pinned side-by-side fleet SHA/topology witness generated by `pnpm kaleidoscope:graph-rag-mcp:pin:write`. |
...
| [`../../../../audit/evidence/kaleidoscope-phase-3-resources-latest.json`](../../../../audit/evidence/kaleidoscope-phase-3-resources-latest.json) | Phase 3 internal product resources witness generated by `pnpm kaleidoscope:phase-3-resources:write`. |
| [`../../../../audit/evidence/kaleidoscope-phase-3-resource-replay-latest.json`](../../../../audit/evidence/kaleidoscope-phase-3-resource-replay-latest.json) | Phase 3 resource replay witness generated by `pnpm kaleidoscope:phase-3-resource-replay:write`. |
...
| [`phase-3-resource-replay-latest.md`](./phase-3-resource-replay-latest.md) | Phase 3 product resource replay report with semantic fingerprints and witness file hashes. |
| [`graph-rag-mcp-strict-fleet-pin-latest.md`](./graph-rag-mcp-strict-fleet-pin-latest.md) | Pinned Graph/RAG/MCP strict-gate fleet topology and SHA report. |
