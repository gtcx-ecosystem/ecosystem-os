...
| [`../../../../pm/spec/kaleidoscope-ai/phase-3-resources.schema.json`](../../../../pm/spec/kaleidoscope-ai/phase-3-resources.schema.json) | Phase 3 internal read-only resources witness contract for `/fleet`, `/graph`, `/signal`, `/release`, and `/phase-2`. |
...
| [`../../../../audit/evidence/kaleidoscope-phase-3-resources-latest.json`](../../../../audit/evidence/kaleidoscope-phase-3-resources-latest.json) | Phase 3 internal read-only resources witness generated by `pnpm kaleidoscope:phase-3-resources:write`. |
