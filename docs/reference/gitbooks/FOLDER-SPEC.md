---
title: 'reference/gitbooks/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'reference/gitbooks']
review_cycle: on-change
---

# `docs/reference/gitbooks/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

reference/gitbooks/ narrative and specs for ecosystem-os.
