---
title: 'Political & Reputational Risks'
status: current
date: 2026-05-26
...
- Environmental/Social Concerns: Some institutions may avoid gold sourced from mercury-laced artisanal mines. AGX should promote best practices: possibly offer premium pricing for mercury-free or large-scale mine gold, echoing efforts like PlanetGOLD. It could publish impact reports (e.g. how much mercury-free gold was traded).
- NGO Criticism: If AGX fails to enforce human-rights standards, NGOs will criticize it. For example, blockchain in Brazil was hailed as “pivotal” to protecting forests, but critics pointed out it doesn’t ensure miners are treated fairly. AGX must be transparent about what it does and does not cover. It should not claim “responsible mining” purely because of blockchain; rather, tie in with initiatives (e.g. supporting miners’ education or community funds) if possible.<br>
