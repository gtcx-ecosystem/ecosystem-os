---
title: 'Guide: Writing Documentation'
status: 'current'
date: '2026-05-24'
...
- Numbered doc folders use **underscore**: `01_context`, `02_vision`, `03_product`
- The one exception: `README.md` is always uppercase
- Do not use spaces or camelCase in filenames
...
```markdown
<!-- Good -->
See [architecture overview](../../../architecture/product-architecture.md)

<!-- Bad -->
See [architecture overview](../../../operations/field-guides/field-guides/overview.md)
````
...
For authentication details, see [auth architecture](../../../README.md).
...
Every folder in `01-docs/` gets a `README.md`. The README serves as navigation, not content.
...
| ---------------------------- | ------------------------------------- |
| [overview.md](../../../operations/field-guides/field-guides/overview.md)   | High-level system architecture        |
| [data-flow.md](../../../engineering/reference/archive/legacy-authoritative/_archive/diagrams/data-flow.md) | Data flow between services            |
| [decisions/](../../archive/legacy-authoritative/_archive/decisions/)     | Architectural Decision Records (ADRs) |
```
...
| Leaving TODO/template-token text in committed docs     | Readers do not know if it is a template-token or the actual content | Remove TODOs before committing, or do not commit the file yet                                                 |
...
- [ ] **No template-token text.** No `TODO`, `pending`, `FIXME`, or `[fill in later]` markers.
...
- [1-protocols/docs-structure/protocol.md](../../../governance/protocols/1-docs-structure/protocol.md)
- [repo-folders-readme-template.md](../../../engineering/system-design/repo-folders-readme-template.md)
- [hygiene/templates/documentation-hygiene.md](../../templates/agile/8-hygiene/templates/documentation-hygiene.md)
