---
title: 'Guide: AI-Assisted Development'
status: current
date: 2026-05-24
...
| Business logic requiring domain expertise | AI does not understand [your domain]. You do.                                                             |
...
- File: services/trade-api/03-platform/src/modules/orders/orders.module.ts
...
```
Look at services/compliance-api/03-platform/src/modules/reports/reports.service.ts.
...
- Match existing error handling in 03-platform/src/common/filters/
...
- [1-protocols/code-standards/protocol.md](../../../governance/protocols/5-code-standards/protocol.md) for style and structure
- [1-protocols/naming-conventions/protocol.md](../../../governance/protocols/3-naming-conventions/protocol.md) for naming
- [1-protocols/testing/protocol.md](../../../governance/protocols/6-testing/protocol.md) for test patterns
...
- [Session Recap](../../templates/sessions/5-session-recaps/session-recap.md) -- Document what was accomplished in each AI-assisted session
- [Hallucination Audit](../../templates/agile/4-audits/templates/hallucination-audit.md) -- Verify AI-generated content for fabricated claims
- [Code Quality Audit](../../templates/agile/4-audits/templates/code-quality-audit.md) -- Structured review of AI-generated code quality
