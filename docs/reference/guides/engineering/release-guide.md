...
```bash
  ...
  [cloud-cli] run deploy SERVICE_NAME --image IMAGE:previous-tag --region REGION
```
...
- [Release Notes Template](../../templates/agile/5-reports/templates/release-notes.md)
- [Production Readiness Template](../../templates/agile/5-reports/templates/production-readiness.md)
- [CI/CD Protocol](../../../governance/protocols/7-ci-cd/protocol.md)
