---
title: 'Guide: Agent Context Recovery'
status: current
date: 2026-05-24
...
Use the template at `session-docs/templates/session-recap.md`.

Store in: `01-docs/specs/_project/planning/sessions/` or a dedicated sessions folder.
...
- [repo/4-sessions/5-session-recaps/session-recap.md](../../templates/sessions/5-session-recaps/session-recap.md)
- [repo/4-sessions/4-session-insights/project-insights.md](../../templates/sessions/4-session-insights/project-insights.md)
- [repo/1-agents/onboarding/service-overview.md](../../agent-sops/1-onboarding/service-overview.md)
- [repo/reference/archive/legacy-authoritative/_archive/decisions/adr-template.md](../../../engineering/decisions/adr-template.md)
- [system/1-protocols/1-docs-structure/protocol.md](../../../governance/protocols/1-docs-structure/protocol.md)
