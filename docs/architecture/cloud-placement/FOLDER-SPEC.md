---
title: 'architecture/cloud-placement/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/cloud-placement']
review_cycle: on-change
---

# `docs/architecture/cloud-placement/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/cloud-placement/ narrative and specs for ecosystem-os.
