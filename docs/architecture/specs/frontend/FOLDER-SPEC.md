---
title: 'architecture/specs/frontend/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/specs/frontend']
review_cycle: on-change
---

# `docs/architecture/specs/frontend/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/specs/frontend/ narrative and specs for ecosystem-os.
