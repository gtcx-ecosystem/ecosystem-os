---
title: 'gitbook/publish/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/publish']
review_cycle: on-change
---

# `docs/gitbook/publish/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/publish/ narrative and specs for ecosystem-os.
