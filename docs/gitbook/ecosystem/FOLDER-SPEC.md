---
title: 'gitbook/ecosystem/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/ecosystem']
review_cycle: on-change
---

# `docs/gitbook/ecosystem/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/ecosystem/ narrative and specs for ecosystem-os.
