---
title: 'gitbook/product/acceptance/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/product/acceptance']
review_cycle: on-change
---

# `docs/gitbook/product/acceptance/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/product/acceptance/ narrative and specs for ecosystem-os.
