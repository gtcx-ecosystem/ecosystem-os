---
title: 'gitbook/product/ux/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/product/ux']
review_cycle: on-change
---

# `docs/gitbook/product/ux/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/product/ux/ narrative and specs for ecosystem-os.
