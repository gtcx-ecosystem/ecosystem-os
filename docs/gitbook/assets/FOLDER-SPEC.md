---
title: 'gitbook/assets/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/assets']
review_cycle: on-change
---

# `docs/gitbook/assets/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/assets/ narrative and specs for ecosystem-os.
