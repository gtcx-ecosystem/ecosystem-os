---
title: 'gitbook/assets/model-pages/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/assets/model-pages']
review_cycle: on-change
---

# `docs/gitbook/assets/model-pages/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/assets/model-pages/ narrative and specs for ecosystem-os.
