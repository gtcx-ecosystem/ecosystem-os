---
title: 'gitbook/business/economics/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/economics']
review_cycle: on-change
---

# `docs/gitbook/business/economics/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/economics/ narrative and specs for ecosystem-os.
