---
title: 'gitbook/business/market/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/market']
review_cycle: on-change
---

# `docs/gitbook/business/market/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/market/ narrative and specs for ecosystem-os.
