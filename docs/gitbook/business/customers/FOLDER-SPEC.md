---
title: 'gitbook/business/customers/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/customers']
review_cycle: on-change
---

# `docs/gitbook/business/customers/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/customers/ narrative and specs for ecosystem-os.
