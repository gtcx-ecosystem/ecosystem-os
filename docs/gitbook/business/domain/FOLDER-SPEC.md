---
title: 'gitbook/business/domain/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/domain']
review_cycle: on-change
---

# `docs/gitbook/business/domain/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/domain/ narrative and specs for ecosystem-os.
