---
title: 'gitbook/business/strategy/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/strategy']
review_cycle: on-change
---

# `docs/gitbook/business/strategy/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/strategy/ narrative and specs for ecosystem-os.
