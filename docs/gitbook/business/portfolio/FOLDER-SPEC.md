---
title: 'gitbook/business/portfolio/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/business/portfolio']
review_cycle: on-change
---

# `docs/gitbook/business/portfolio/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/business/portfolio/ narrative and specs for ecosystem-os.
