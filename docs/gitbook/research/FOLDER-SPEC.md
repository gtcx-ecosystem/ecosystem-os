---
title: 'gitbook/research/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/research']
review_cycle: on-change
---

# `docs/gitbook/research/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/research/ narrative and specs for ecosystem-os.
