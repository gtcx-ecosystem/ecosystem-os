...
[Channel Documentation →](./README.md)
...
- **[[Platform G] API](./endpoints.md)** — REST API reference
- **[MCP Servers](./README.md)** — Internal tool servers (template — see gtcx-protocols GitBook)
- **[Distribution Channels](./README.md)** — Multi-channel delivery (template)
