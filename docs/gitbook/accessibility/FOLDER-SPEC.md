---
title: 'gitbook/accessibility/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/accessibility']
review_cycle: on-change
---

# `docs/gitbook/accessibility/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/accessibility/ narrative and specs for ecosystem-os.
