---
title: 'gitbook/getting-started/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/getting-started']
review_cycle: on-change
---

# `docs/gitbook/getting-started/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/getting-started/ narrative and specs for ecosystem-os.
