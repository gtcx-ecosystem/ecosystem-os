...
- **Go-to-market strategy or commercial execution plans**: See `01-docs/strategy/gtm-q2-africa.md` for GTM strategy and `01-docs/strategy/innovation-opportunities.md` for strategic opportunities
- **Implementation status or codebase maturity assessment**: See `01-docs/strategy/implementation-truth.md` for a tiered assessment of what is built vs. designed
- **Individual protocol specifications or API references**: See `01-docs/specs/` and `gtcx-protocols/` repo for protocol-level documentation
