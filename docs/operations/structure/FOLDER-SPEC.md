---
title: 'operations/structure/ — folder provisioning'
status: current
date: 2026-06-15
owner: ecosystem-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/structure']
review_cycle: on-change
---

# `docs/operations/structure/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/structure/ narrative and specs for ecosystem-os.
