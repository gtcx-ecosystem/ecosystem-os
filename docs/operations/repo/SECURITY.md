...
1. Email **security@gtcx.io** (do not open public issues for security reports).
...
In-scope: this repository's documentation source, configs, publish manifests, and deploy artifacts under `platform/` and `deploy/`.

Out-of-scope: third-party services unless explicitly integrated in this repo's publish path.
