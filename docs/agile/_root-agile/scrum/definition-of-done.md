---
title: 'Definition of Done — ecosystem-os'
status: current
date: 2026-05-27
owner: ecosystem-os
tier: standard
...
# Definition of Done — ecosystem-os

Quality criteria that must be satisfied before any work item in `ecosystem-os` is considered complete.
