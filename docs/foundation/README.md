...
Mandatory agent and operator narrative for **Fleet documentation hub**. Read before `pnpm agent:next-work`.
...
| [manifesto.md](./manifesto.md) | Why ecosystem-os exists |
