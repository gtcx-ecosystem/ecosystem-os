...
│   └── web/                        # web platforms (crx, sgx, agx portals)
...
├── protocols/                      # core verification protocols
...
- **`01-docs/`** - comprehensive technical documentation
- **`protocols/*/SPEC.md`** - protocol specifications
- **`intelligence/sdk/`** - ai/ml sdk for verification
- **project knowledge** - search using project_knowledge_search tool
...
- **`01-docs/README.md`** - documentation hub
- **`01-docs/01-getting-started/`** - onboarding materials
- **`01-docs/02-protocols/`** - protocol documentation
- **`01-docs/07-data-model/`** - data model specifications
...
- **code quality**: ensure consistent coding standards across packages
- **integration testing**: validate cross-package integrations
...
1. **research context**: leverage specs, docs, and project knowledge
...
3. **integration testing**: validate cross-package functionality
...
- **project knowledge**: use project_knowledge_search tool
- **documentation**: browse 01-docs/ directory
- **specifications**: check protocols/\*/SPEC.md
