# ecosystem-os — operator onboarding

## Purpose

This repo is part of the GTCX ecosystem. This document is the **operator entry** for builders and agents working in `ecosystem-os`.

## Prerequisites

- Node 20+ with `corepack enable`
- Clone at `../ecosystem-os` relative to ecosystem root
